...
var core = {
  init: function init(app) {
    ...
    return _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 19:
              ...
              productRawPath = mode === 'hangar' ? '/' + (convention.products ? 'products' : convention.products) : nioHomePath;
      ...
      }, _callee, _this, [[45, 63, 67, 75], [68,, 70, 74]]);
    }))();
  },
