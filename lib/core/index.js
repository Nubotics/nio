...
var core = {
  init: function init(app) {
    ...
    return _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
      ...
      np, env, has, is, includes, _ref, hangarPath, botPath, productPath, shelterPath, cargoPath, developer, createPath, processPath, nioHomePath, mode, nioFile, setPath, config, convention, productRawPath, shelterRawPath, productFolders, productCollection, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, productFolder, currentProductPath, currentProduct;
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (is(nioFile, 'nothing') || is(nioFile, 'zero-len')) {
                nioFile = (0, _lookUp2.default)('*product.js', { cwd: nioHomePath });
                if (!is(nioFile, 'nothing') && !is(nioFile, 'zero-len')) {
                  mode = 'product';
                }
            ...
            case 21:
              ...
              productRawPath = mode === 'hangar' && includes(nioFile, 'hangar') ? '/' + (convention.products ? 'products' : convention.products) : '';
      ...
      }, _callee, _this, [[47, 66, 70, 78], [71,, 73, 77]]);
    }))();
  },
